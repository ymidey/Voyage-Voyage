 <?php
    ...
    $requeteShowAllComments = "SELECT commentaires.*, utilisateurs.pseudo, billets.titre, billets.id_billet FROM commentaires, utilisateurs, billets WHERE commentaires.id_user = utilisateurs.id && billets.id_billet = commentaires.id_Billets";
         ...
         <tbody>
             <?php foreach ($resultShowUtilisateurs as $showUtilisateurs) : ?>
                 <tr>
                     ...
                     <td data-title="Supprimer"><a href="traiteadmin.php?requete=deluser&delete=<?php echo $showUtilisateurs["id"] ?>" onclick="return confirm('Voulez-vous vraiment supprimer cette utilisateur')">Supprimer</a>
                     </td>
                 </tr>
             <?php endforeach; ?>
         </tbody>
         ...
         <tbody>
             <?php foreach ($resultShowAllComments as $comments) : ?>
                 <tr>
                     ...
                     <td data-title="billet"><a href="billet.php?id_billet=<?php echo $comments["id_billet"] ?>"><?php echo $comments["titre"] ?></a>
                     </td>
                     <td data-title="contenu"><?php echo $comments["contenu"] ?> </td>
                     <td data-title="datePublication"><?php echo $comments["date_publication"] ?> </td>
                     <td data-title="Supprimer"><a href="traiteadmin.php?requete=delcom&delete=<?php echo $comments["id_commentaire"] ?>" onclick="return confirm('Voulez-vous vraiment supprimer ce commentaire')">Supprimer</a>
                     </td>
                 </tr>
             <?php endforeach; ?>
         </tbody>
